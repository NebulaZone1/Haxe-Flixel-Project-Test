...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("ProjectTest",ab,7f,d5,0b),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("NebulaZone",ab,f4,c8,fa));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("ProjectTest",ab,7f,d5,0b));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Project Test",39,cb,dc,52));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Project Test",39,cb,dc,52))
